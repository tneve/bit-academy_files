    ...
    <div class="container">
        ...
        foreach ($posts as $post) :
            ...
            <div class="post">
                ...
                <?php
                $sql = 'SELECT tags.titel FROM tags INNER JOIN posts_tags ON tags.id = posts_tags.tag_id WHERE posts_tags.post_id = :post_id';
                ...
                $tags = $stmt->fetchAll();
                ?>
                <span class="details">Tags: <?php
                foreach ($tags as $tag) : ?>
                        <a href="lookup.php?tag=<?= $tag['titel'] ?>"><?= $tag['titel'] ?></a>
                <?php endforeach ?>
                </span>
